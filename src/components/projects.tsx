...
//       description:
//         "Developed an intelligent geospatial data retrieval system that uses Large Language Models (LLMs), Natural Language Processing (NLP), and Agentic AI (Crew AI) to provide personalized and context-aware location recommendations. The system understands natural language queries and dynamically assigns tasks to specialized AI agents for enhanced modularity and automation.",
...
//       description:
//         "Developed a deep learning model using Convolutional Neural Networks (CNN) to detect brain tumors from MRI scans. The model classifies images into tumor and non-tumor categories with high accuracy. The project involved data preprocessing, augmentation, and model tuning to improve performance.",
//       technologies: [
//         "Python",
//         "TensorFlow",
//         "Keras",
...
//       description:
//         "Built a Retrieval-Augmented Generation (RAG) based chatbot that allows users to ask questions about the content of any uploaded PDF. The system extracts relevant context from the PDF and uses Gemini Pro API to generate accurate, human-like answers, combining document parsing with LLM capabilities.",
//       technologies: [
//         "Python",
//         "Streamlit",
//         "Gemini API",
...
//           <div className="inline-flex items-center gap-2 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white rounded-2xl font-medium hover:from-blue-700 hover:to-purple-700 transition-all duration-300 transform hover:scale-105 shadow-lg cursor-pointer">
...
const ProjectsSection: React.FC = () => {
  ...
  // Your actual projects data with enhanced details
  const projects: Project[] = [
    {
      id: 1,
      title: "Context Aware Geospatial Data Retrieval System",
          ...
          <div className="mb-8">
            ...
            <div className="flex flex-wrap gap-3">
              {project.technologies.map((tech, index) => (
                <span
                  key={index}
                  className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-blue-100 to-purple-100 dark:from-blue-900/30 dark:to-purple-900/30 text-blue-800 dark:text-blue-300 rounded-full font-medium"
                >
